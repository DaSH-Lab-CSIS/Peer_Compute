...
def minimize_total_cost(workers, jobs, cost_matrix, delay):
    ...
    prob += pulp.lpSum(x[worker, job] * cost_matrix[worker][job]
                       for worker in workers for job in jobs) + \
            pulp.lpSum(delay[worker] * (1 if pulp.lpSum(x[(worker, job)] for job in jobs) >= 1 else 0)
...
if __name__ == '__main__':
    ...
    cost_matrix = {
        'Worker1': {'Job1': 10, 'Job2': 15, 'Job3': 20, 'Job4': 25, 'Job5': 30,
                    'Job6': 35, 'Job7': 40, 'Job8': 45, 'Job9': 50, 'Job10': 55},
        'Worker2': {'Job1': 20, 'Job2': 25, 'Job3': 30, 'Job4': 35, 'Job5': 40,
                    'Job6': 45, 'Job7': 50, 'Job8': 55, 'Job9': 60, 'Job10': 65},
        'Worker3': {'Job1': 30, 'Job2': 35, 'Job3': 40, 'Job4': 45, 'Job5': 50,
                    'Job6': 55, 'Job7': 60, 'Job8': 65, 'Job9': 70, 'Job10': 75},
        'Worker4': {'Job1': 40, 'Job2': 45, 'Job3': 50, 'Job4': 55, 'Job5': 60,
                    'Job6': 65, 'Job7': 70, 'Job8': 75, 'Job9': 80, 'Job10': 85},
        'Worker5': {'Job1': 50, 'Job2': 55, 'Job3': 60, 'Job4': 65, 'Job5': 70,
                    'Job6': 75, 'Job7': 80, 'Job8': 85, 'Job9': 90, 'Job10': 95},
        'Worker6': {'Job1': 60, 'Job2': 65, 'Job3': 70, 'Job4': 75, 'Job5': 80,
                    'Job6': 85, 'Job7': 90, 'Job8': 95, 'Job9': 100, 'Job10': 105}
    }
    
    # Define fixed delay dictionary
    delay = {
        'Worker1': 0, 'Worker2': 20, 'Worker3': 10,
        'Worker4': 30, 'Worker5': 15, 'Worker6': 25
    }
